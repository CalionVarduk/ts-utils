import { Task, ContinuationTask, TaskBase, JoinedTask, RacingTask, MappedTask } from '../../core/tasks/task';
...
import { TaskContinuationStrategy } from '../../core/tasks/task-continuation-strategy.enum';
import { ITask } from '../../core/tasks/task.interface';
import { TaskResult } from '../../core/tasks/task-result';
import { instanceOfCast, wait } from '../../core/functions';
